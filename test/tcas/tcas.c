...
void _symbolic_initialize()
{
  klee_make_symbolic(Positive_RA_Alt_Thresh, sizeof(Positive_RA_Alt_Thresh), "Positive_RA_Alt_Thresh");
}
...
{
 int a;
 klee_make_symbolic(&a, sizeof a, "a_symbolic_ALIM ");
 return a;
}
...
int _symbolic_Inhibit_Biased_Climb ()
{
    int a;
    klee_make_symbolic(&a, sizeof a, "a_symbolic_Inhibit_Biased_Climb ");
    return a;
}
...
bool _symbolic_Non_Crossing_Biased_Climb()
{
 int a;
 klee_make_symbolic(&a, sizeof a, "a_symbolic_Non_Crossing_Biased_Climb");
 klee_assume(a == 0 || a == 1);
 return a;
}
...
bool _symbolic_Non_Crossing_Biased_Descend()
{
 int a;
 klee_make_symbolic(&a, sizeof a, "a_symbolic_Non_Crossing_Biased_Descend");
 klee_assume(a == 0 || a == 1);
 return a;
}
...
bool _symbolic_Own_Below_Threat()
{
 int a;
 klee_make_symbolic(&a, sizeof a, "a_symbolic_Own_Below_Threat");
 klee_assume(a == 0 || a == 1);
 return a;
}
...
bool _symbolic_Own_Above_Threat()
{
 int a;
 klee_make_symbolic(&a, sizeof a, "a_symbolic_Own_Above_Threat");
 klee_assume(a == 0 || a == 1);
 return a;
}
...
int _symbolic_alt_sep_test()
{
 int a;
 klee_make_symbolic(&a, sizeof a, "a_symbolic_alt_sep_test");
 return a;
}
